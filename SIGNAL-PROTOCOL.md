...
Status: v1 · 2026-07-09 · governs how raw Sillage detections become scored, ranked,
...
vocabulary is *their product language*. Classes:

- **K1 — high precision (trigger-grade):** `"vendor management"`, `"vendor selection"`,
  `"third-party risk"`, `"market entry"`, `"regional expansion"`, `"proof of concept"`,
  `EMEA`, `RFP` · CJK set (`海外事業`, `経営企画`, `グローバル`, `글로벌`, `해외사업`,
  `전략기획`) — **experimental (grade C) until first live hit; do not weight until
  audited.**
- **K2 — medium (trigger, lower weight):** `international`, `Europe`, `European`,
  `overseas`, `"global expansion"`, `"partnership manager"`, `alliances`.
- **K3 — noisy at banks (validator-only, weight ≈ 0 standalone):** `"cross-border"`,
  `"strategic partnerships"`, `"digital transformation"`, `"core banking"`,
  `"core modernization"`, `"cloud migration"`, `"open banking"`,
  `"embedded finance"`, `"global markets"` → **REMOVED from agent entirely** ("Global
  Markets" is a standard bank division name; observed firing on a generic relationship-
  manager posting).
...
|---|---|---|
| #2680 job postings (K1/K2) | A | 340+ live detections, incl. true positive: Nium "Director – Partnerships & Network Management, Expansion" |
| #2680 (K3 keywords) | B | UOB relationship-manager false-positive class |
| #2680 (CJK keywords) | C | zero observed hits so far |
...
4. **Current quality estimate (2026-07-09, pre-audit):**
   - Type 1 hiring: **usable now** — 340 detections pre-widening + 200+ post-widening
     (concentration: first 200 all UOB — audit before trusting); K1 subset is
     demo-grade.
